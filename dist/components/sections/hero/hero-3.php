<div class="bg-dark relative">
  ...
  <div class="absolute inset-0 flex justify-center">
    <div class="container-whide relative w-screen">
      ...
      <div
        class="pointer-events-none absolute bottom-[340px] left-[30%] z-3 w-[150px] -translate-x-1/2 -rotate-10 md:top-[25px] md:left-[47%] md:w-[250px]"
      >
  ...
  <div class="container-base">
    <div
      class="grid min-h-[720px] items-center gap-20 py-10.5 max-md:grid-rows-[1fr_auto] md:min-h-[602px] md:grid-cols-2 md:gap-8 md:py-20"
    >
      ...
      <div class="glass relative z-5 overflow-hidden"><?php include 'components/forms/main.php' ?></div>
    </div>
  </div>
</div>
