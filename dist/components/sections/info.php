    ...
    <div class="md:border-primary-light md:rounded-[20px] md:border md:px-20 md:py-8">
      ...
      >
        <h2 class="h3 flex flex-wrap items-center gap-x-4 gap-y-5">
          ...
          <span
            class="inline-flex items-center justify-center rounded-full bg-emerald-600 px-2 pt-1.5 pb-0.5 text-sm leading-none text-white uppercase"
          >
