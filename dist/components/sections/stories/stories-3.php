<div class="py-14 md:py-20" id="reviews">
  <div class="container-base grid items-start gap-6 md:gap-8 lg:grid-cols-3">
    <div class="grid gap-3 max-lg:text-center md:gap-4">
      <h2><?= t('t.index.stories_title') ?></h2>
      <p class="text-big"><?= t('t.index.stories_text') ?></p>
    </div>
    <div class="relative grid gap-2 md:px-20 lg:col-span-2">
      <div class="grid gap-1.5 overflow-hidden" data-slider="stories">
        <div class="-ml-6 flex md:-ml-8">
          <?php foreach (getReviewsVideoIds() as $videoId) { ?>
          <div class="basis-full pl-6 sm:basis-2/4 md:pl-8">
      ...
      >
        <button class="arrow-btn mirror-x" data-prev="stories" aria-label="<?= t('t.aria.prev_slide') ?>">
          <?php include 'components/icons/arrow-slider.php' ?>
        </button>
        <button class="arrow-btn" data-next="stories" aria-label="<?= t('t.aria.next_slide') ?>">
          <?php include 'components/icons/arrow-slider.php' ?>
        </button>
      </div>
    </div>
